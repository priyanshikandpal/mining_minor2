import argparse
import urllib.parse  # Use urllib.parse instead of deprecated urllib and urllib2
import json
import datetime
import random
import os
...
class TwitterData:
    ...
    def parse_config(self):
      ...
      if os.path.exists('config.json'):
          ...
          parser.add_argument('-ck', '--consumer_key', default=None, help='Your developer `Consumer Key`')
          parser.add_argument('-cs', '--consumer_secret', default=None, help='Your developer `Consumer Secret`')
    ...
    def getData(self, keyword, params = {}):
        ...
        if 'errors' in jsonData:
            print ("API Error"); print (jsonData['errors'])
        else:
